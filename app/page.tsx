        ...
        {messages.length > 0 ? (
          messages.map((message, i) => (
            <div
              key={i}
              className={clsx(
                "flex w-full items-center justify-centre py-3 pl-4 w-10 h-10 animate-fadeInSlideUp rounded-md",
                message.role === "user"
            ...
            >
              <div className="flex w-full items-start space-x-4">
                <div
                  className={clsx(
                    "flex items-center justify-center py-3 pl-4 w-10 h-10 animate-fadeInSlideUp p-1.5 text-white rounded-md",
